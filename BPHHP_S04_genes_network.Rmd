...
But the are obviously many (>20.000) more, and if you come across something in the literature, you can look the official code name here: https://www.genenames.org/ and add it to the list. But maybe for now, let start of with these genes:
...
```
**What do you notice ?** If the values are fairly high, would could be a critical explanation? 
