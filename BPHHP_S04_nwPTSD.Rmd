...
Next you can get quatify the observation of the network a bit, but plotting the centrality of the nodes. **What is centrlality?** (purely concentually, don't worry about the stats for now)
